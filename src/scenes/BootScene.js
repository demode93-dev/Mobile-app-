...
import JournalManager from '../systems/JournalManager.js';

const SPRITE_KEYS = ['hero', 'skeleton', 'mimic', 'cultist', 'bat', 'mushroom', 'wraith', 'tile_red', 'tile_blue', 'tile_purple', 'tile_green', 'tile_brown'];
...
const FALLBACK_COLORS = {
  ...
  tile_red: 0xc0392b, tile_blue: 0x2e6da4, tile_purple: 0x8e44ad, tile_green: 0x27ae60, tile_brown: 0x8b5a2b,
...
export default class BootScene extends Phaser.Scene {
  ...
  create() {
    ...
    if (!this.registry.get('journal')) {
      this.registry.set('journal', new JournalManager());
    }
